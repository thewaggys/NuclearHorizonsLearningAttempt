...
public class FuelRodRecipes {
    ...
    public static void registerCanning() {
        GTValues.RA.stdBuilder()
            .itemInputs(new ItemStack(Loaders.advancedFuelRod, 1), ENRICHED_URANIUM_FUEL.getDust(4))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(new ItemStack(Loaders.advancedFuelRod, 2), ENRICHED_URANIUM_FUEL.getDust(8))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(new ItemStack(Loaders.advancedFuelRod, 4), ENRICHED_URANIUM_FUEL.getDust(16))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(new ItemStack(Loaders.advancedFuelRod, 1), ENRICHED_THORIUM_FUEL.getDust(2))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(new ItemStack(Loaders.advancedFuelRod, 2), ENRICHED_THORIUM_FUEL.getDust(4))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(new ItemStack(Loaders.advancedFuelRod, 4), ENRICHED_THORIUM_FUEL.getDust(8))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(new ItemStack(Loaders.advancedFuelRod, 1), ENRICHED_MOX_FUEL.getDust(4))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(new ItemStack(Loaders.advancedFuelRod, 2), ENRICHED_MOX_FUEL.getDust(8))
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(new ItemStack(Loaders.advancedFuelRod, 4), ENRICHED_MOX_FUEL.getDust(16))
    ...
    public static void registerRecyclingRecipes() {
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(DEPLETED_THORIUM_FUEL.getDust(4), new ItemStack(Loaders.advancedFuelRod, 1))
            .duration(20 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(thermalCentrifugeRecipes);
        ...
        GTValues.RA.stdBuilder()
            ...
            .itemOutputs(DEPLETED_THORIUM_FUEL.getDust(8), new ItemStack(Loaders.advancedFuelRod, 2))
            .duration(40 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(thermalCentrifugeRecipes);
        ...
        GTValues.RA.stdBuilder()
            .itemInputs(new ItemStack(ItemList.DEPLETED_THORIUM_2X_ROD, 1))
            .itemOutputs(DEPLETED_THORIUM_FUEL.getDust(16), new ItemStack(Loaders.advancedFuelRod, 4))
            .duration(80 * SECONDS)
            .eut(TierEU.RECIPE_MV)
            .addTo(thermalCentrifugeRecipes);
